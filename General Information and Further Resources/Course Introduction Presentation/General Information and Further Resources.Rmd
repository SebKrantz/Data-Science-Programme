...
- Books for [programming](<https://bookdown.org/rdpeng/rprogdatascience/subsetting-r-objects.html>), [statistics](<https://www.nongnu.org/ipsur/index.html>), [applied statistics](<https://daviddalpiaz.github.io/appliedstats/>), [econometrics](<https://www.econometrics-with-r.org/>), [time series](<https://www.stat.pitt.edu/stoffer/tsa4/>), [statistical learning](<https://www.statlearning.com/>) and [geocomputation](<https://geocompr.robinlovelace.net/>)
- Websites for [quick help](<https://www.statmethods.net/index.html>) and [full university courses](<https://cfss.uchicago.edu/>). See [here](<https://sites.google.com/site/econometricsacademy>) for great econometrics courses using R or STATA. 
...
![The Pyramid of Digital Proficiency.](IMG_2155.PNG)
