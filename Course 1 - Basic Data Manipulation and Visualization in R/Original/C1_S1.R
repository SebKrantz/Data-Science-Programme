...
any(class(econ.score) %in% "bla") # Same thing as what inherits does..
...
m[1:5] # Although m is now a matrix, it retains all essential properties of a vector, including 1D subsetting
